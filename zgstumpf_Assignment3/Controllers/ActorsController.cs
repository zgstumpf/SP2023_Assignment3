...
namespace zgstumpf_Assignment3.Controllers
{
    public class ActorsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Gender,Age,ImdbHyperlink,PhotoUrl")] Actor actor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("Id,Name,Gender,Age,ImdbHyperlink,PhotoUrl")] Actor actor)
        {
            if (id != actor.Id)
            {
                return NotFound();
